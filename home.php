...
<div class="wrapper">
  ...
  <?php
   $stock  = mysqli_fetch_array(mysqli_query($koneksi, "SELECT count(*) as semua FROM tbl_transaksi_detail where kode_member='$_SESSION[kode_member]' and status='Belum' "));
  ?>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="home.php?module=home">Beranda</a></li>
            <li><a href="home.php?module=pelanggan&atc=tambah">Kosmetik</a></li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
        <!-- Navbar Right Menu -->
        <div class="navbar-custom-menu">
          ...
          <li class="dropdown notifications-menu">
            <a href="home.php?module=pelanggan&atc=bayar" class="btn btn-flat">
              &nbsp;<i class="fa fa-shopping-cart"></i>&nbsp;
              <?php echo'<span class="label label-success">'.$stock['semua'] ; ?></span>
            </a>
            ...
            <li class="dropdown user user-menu">
              <!-- Menu Toggle Button -->
              <a onclick="logout()" class="btn btn-flat">

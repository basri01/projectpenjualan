      ...
      <div class="login-box-body">
        ...
        <form action="" method="post">
          <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
              <input class="form-control" type="password"  autofocus required name="password" placeholder="Password">
        ...
        <a href="member.php" class="text-center">Register a New Member</a>
      </div><!-- /.login-box-body -->
...
if($_POST["Login"]){ 
  ...
  if($user!="" && $password!=""){
    $em = mysqli_query($koneksi, "select * from tbl_member where password='$password' AND username='$user'");

...
$query = "SELECT * FROM tbl_barang_masuk WHERE kode_bm='$id' ";
$sql              = mysqli_query ($koneksi, $query);
$hasil            = mysqli_fetch_array ($sql);
  $kode           = addslashes (strip_tags ($hasil['kode_bm']));
  $kode_barang    = addslashes (strip_tags ($hasil['kode_barang']));
  $tanggal        = addslashes (strip_tags ($hasil['tanggal']));
  $jumlah_bm      = addslashes (strip_tags ($hasil['jumlah_bm']));
  $harga_beli     = addslashes (strip_tags ($hasil['harga_beli']));
   $total     = addslashes (strip_tags ($hasil['total']));
...
if (isset($_POST['edit'])) {
  ...
  $query = "UPDATE tbl_barang_masuk SET kode_barang='$kode_barang', tanggal='$tanggal', jumlah_bm='$jumlah', harga_beli='$harga', total='$total' where kode_bm='$id' ";
  $sql = mysqli_query ($koneksi, $query);
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" required placeholder="Tanggal" name="tanggal" id="datepicker" name="tanggal" value="<?php echo $tanggal ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" required placeholder="Jumlah" name="jumlah" id='jumlah' onkeyup="sum();" value="<?php echo $jumlah_bm ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="tiga" class="col-sm-3 control-label">Harga</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" required placeholder="Harga Beli" name="harga" id="harga" onkeyup="sum();" maxlength="15" value="<?php echo $harga_beli ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="tiga" class="col-sm-3 control-label">Total</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" required placeholder="Harga Beli" name="total" id="total" maxlength="15" value="<?php echo $total ?>" readonly>
                            </div>
                        </div>
                        <br>
                      ...
                      <div class="form-group">
                        <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-4">
                          ...
                          <a href="index2.php?module=barang_masuk" class="btn btn-danger btn-md" > <i class="glyphicon glyphicon-remove "></i> Cancel</a>
                        </div>
                      </div>

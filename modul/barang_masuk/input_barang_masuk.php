<?php
 $sql=mysqli_query($koneksi, "SELECT max(kode_bm) as idMaks FROM tbl_barang_masuk");
...
$noUrut++;
 ...
 $tahun=date('Y');
      $tahunbarang="BRM".substr($tahun, 2, 2);
      $char = $tahunbarang;
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" required placeholder="Harga Beli" name="harga" maxlength="15">
                            </div>
                        </div>
                        <br>
                        <!--input image awal-->
...
IF (Isset($_POST['OK']))  {
 ...
 $total = str_replace(".", "",$_POST['harga'])*$_POST['jumlah'];

  $query  = mysqli_query ($koneksi, "INSERT INTO tbl_barang_masuk (kode_bm,kode_barang,tanggal,jumlah_bm,harga_beli,total) VALUES ('$kode','$kode_barang','$tanggal','$jumlah','$harga','$total')");

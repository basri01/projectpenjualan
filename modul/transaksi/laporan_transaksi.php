          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
             <div class="table-responsive"> <br>&nbsp;&nbsp;&nbsp;
              ...
              <img class="image-rounded" src="images/G1.png" align="right" border="" style="width: 200px; height: 120px;" >
         <h3><b>LAPORAN PENJUALAN TOKO BEAUTY KOSMETIK</b></h3>
         <h5>Email : beautykosmetik.id@gmail.com <br>
         Alamat : Jalan Toddopuli Raya Timur, Kel Paropo, Kec Panakkukang, Kota Makassar, Sulawesi Selatan
        </h5></P>  
             ...
             IF (Isset($_POST['cari']) || $_POST['tlgl1']!="" || $_POST['tlgl2']!="")  {
                $no += 1;
                $sql = mysqli_query($koneksi, "SELECT a.kode_transaksi, b.nama, d.jumlah, d.harga, d.tanggal_beli, c.kode_barang, c.nama_barang FROM tbl_transaksi a, tbl_member b, tbl_barang c, tbl_transaksi_detail d where a.kode_member=b.kode_member and d.kode_barang=c.kode_barang and a.kode_transaksi=d.kode_transaksi and tanggal between '$_POST[tgl1]' and '$_POST[tgl2]' order by a.kode_transaksi");
                ...
                <tr>
                  ...
                  <td lign='center'><?php echo $r['tanggal_beli']; ?></td>
              ...
              <?php
               ...
               <img class="image-rounded" src="images/L4.jpg" align="right" style="width: 200px; height: 100px;" >
            </div>
          </div>
